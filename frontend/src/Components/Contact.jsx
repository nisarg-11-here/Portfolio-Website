    ...
    <div className="panel" id="panel_4">
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          {/* <IconButton href="https://github.com/nisarg-11-here" className="m-3 mt-2 mb-0">
                    <GitHubIcon
                    fontSize="large"
                    color="black"
                    />
                ...
                <IconButton href="https://www.linkedin.com/in/nisargchaudhary/" className="m-3 mt-2 mb-0">
                    <LinkedInIcon
                        fontSize="large"
                    />
                </IconButton>
