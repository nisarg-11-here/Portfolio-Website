...
function Home() {
  ...
  return (
    <div className="panel" id="panel_1">
      <div>
        <Container
          className="sans-font homepage-container"
        ...
        >
          ...
          <Row id="homePage" className="text-white" style={{}}>
            <Col md={!isSmallScreen ? "auto" : "7"} className="">
              <Card className="different text-white rounded-3 p-3 card-effect">
              ...
              <Card className="tech-card text-white rounded-3 mt-4 p-3 card-effect">
            ...
            {isSmallScreen && (
              <Col md="5" className="">
                <Card className="text-white rounded-3 card-effect">
                  <Card.Body>
                    <Card.Text>Hello Visitor!</Card.Text>
                    <Card.Text>
                      I am an Undergarduate Computer Science student with
                      passion for Art. Pursuing a minor in Studio Arts to
                      complement my technical studies.
                      <p>
                        Interested in Software Development, Frontend
                ...
                <Card className=" text-white rounded-3 text-center mt-4 card-effect">
                  <Card.Link
                    href="/Resume.pdf"
                    target="_blank"
