    ...
    <div className="panel" id="panel_1">
      <div>
        ...
        >
          ...
          <Row id="homePage" className="" style={{}}>
            <Col md={!isSmallScreen ? "auto" : "7"} className="">
              <Card className="different rounded-3 p-3 card-effect">
              ...
              <Card className="tech-card rounded-3 mt-4 p-3 card-effect">
            ...
            {isSmallScreen && (
              <Col md="5" className="">
                <Card className="rounded-3 card-effect">
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      <p>
                        Passionate about Software Development, Frontend
                ...
                <Card className="rounded-3 text-center mt-4 card-effect sans-font">
                  <Card.Link
                    href="/Resume.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="m-4 Card-Link"
                  >
